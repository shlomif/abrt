...
rlJournalStart
    ...
    rlPhaseStartTest "Invalid XML interface file"
        ...
        INVALID_XML_PATH=$INTERFACES_DIR/invalid.xml
    ...
    rlPhaseStartTest "Missing node's both conf files"
        ...
        XML_PATH=$INTERFACES_DIR/missing_both_node_configuration_annots.xml
    ...
    rlPhaseStartTest "Missing node's working conf file annotation"
        ...
        XML_PATH=$INTERFACES_DIR/missing_working_node_configuration_annot.xml
    ...
    rlPhaseStartTest "Missing node's default conf file annotation"
        ...
        XML_PATH=$INTERFACES_DIR/missing_default_node_configuration_annot.xml
    ...
    rlPhaseStartTest "Only property's working annotation"
        ...
        XML_PATH=$INTERFACES_DIR/only_working_property_configuration_annot.xml
    ...
    rlPhaseStartTest "Only property's default annotation"
        ...
        XML_PATH=$INTERFACES_DIR/only_default_property_configuration_annot.xml
    ...
    rlPhaseStartTest "Not existing node's configuration files"
        ...
        XML_PATH=$INTERFACES_DIR/not_existing_node_configuration.xml
        ...
        rlRun "abrt-configuration -t1 >$LOG_FILE 2>&1 &"
    ...
    rlPhaseStartTest "Not existing node's default file"
        ...
        XML_PATH=$INTERFACES_DIR/not_existing_default_node_configuration.xml
    ...
    rlPhaseStartTest "Unsupported property type"
        ...
        XML_PATH=$INTERFACES_DIR/unsupported_type.xml
